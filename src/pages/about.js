    ...
    return (
        <Layout>
            ...
            <User
                ...
                excerpt="Meu nome é Rebeca Emi Ito, tenho 19 anos e sou aluna do curso de Ciência da Computação da UniFil (Centro Universitário da Filadélfia, Londrina). Atualmente estou no 2º ano (3 período) do curso. Tenho hobbie como artista(tradicional e digital), fazer webcomics e escritora. Futuramente, pretendo criar meu próprio site, onde vou colocar meus projetos, tais como jogos (códigos, disigner de personagem e levels, e OST), comics e artes."
            /> 
            <User
                username="Wellington"
                ...
                excerpt="Meu nome é Wellington Joji Endo, tenho 20 anos e sou aluno do curso de Ciência da Computação da UniFil (Centro Universitário da Filadélfia, Londrina). Atualmente estou no 2° Ano no 3° Período. Tenho alguns hobbies como escritor, faço academia. Posteriormente, penso em ir na área de games, meu desejo é ser roteirista de games ou um Redator."
            />        
            </Layout> 
